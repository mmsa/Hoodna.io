...
@pytest.mark.asyncio
async def test_referral_codes_are_unique_and_redeem_once(db_session):
...
@pytest.mark.asyncio
async def test_preferences_are_lazy_and_patch_contract_fields(db_session):
...
@pytest.mark.asyncio
async def test_pending_deletion_request_is_idempotent(db_session):
